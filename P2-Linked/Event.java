...
public abstract class Event {
     ...
     */
    protected int insertionTime; //simulation time when an event is inserted == currentTime
     ...
     */
    protected int arrivalTime; //simulation time when and event is inserted + duration
